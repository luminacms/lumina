<template>
    <div class="wf-form wf-widgetsettings">
        <div v-if="supportSetting.label" class="wf-setter-field wf-setting-label">
            <div class="fieldname">
                <span>标题</span>
        ...
        <div v-if="supportSetting.label2" class="wf-setter-field wf-setting-label">
            <div class="fieldname">
                <span>标题2</span>
                <span class="fieldinfo">最多10个字</span>
            </div>
        ...
        <div v-if="supportSetting.action" class="wf-setter-field wf-setting-label">
            <div class="fieldname">
                <span>动作名称</span>
                <span class="fieldinfo">最多10个字</span>
            </div>
        ...
        <div v-if="supportSetting.textnote" class="wf-setter-field wf-setting-content">
            <div class="fieldname">
                <span>说明文字</span>
        ...
        <div v-if="supportSetting.placeholder" class="wf-setter-field wf-setting-placeholder">
            <div class="fieldname">
                <span>提示文字</span>
        ...
        <div v-if="supportSetting.placeholder2" class="wf-setter-field wf-setting-placeholder">
            <div class="fieldname">
                <span>提示文字</span>
                <span class="fieldinfo">最多20个字</span>
            </div>
        ...
        <div v-if="supportSetting.href" class="wf-setter-field wf-setting-display">
            <div class="fieldname">
        ...
        <div v-if="supportSetting.dateformat" class="wf-setter-field wf-setting-placeholder">
            <div class="fieldname">
                <span>日期类型</span>
            </div>
            <div class="fieldname">
        ...
        <div v-if="supportSetting.uint" class="wf-setter-field wf-setting-placeholder">
            <div class="fieldname">
                <span>单位</span>
                <span class="fieldinfo">最多20个字</span>
            </div>
        ...
        <div v-if="supportSetting.defaultOptions" class="wf-setter-field wf-setting-options">
            <div class="fieldname">
                <span>选项</span>
        ...
        <div v-if="supportSetting.important" class="wf-setter-field wf-setting-required">
        ...
        <div v-if="supportSetting.translate" class="wf-setter-field wf-setting-conformat">
        ...
        <div v-if="supportSetting.autorekonTime" class="wf-setter-field-group">
            <div class="wf-setter-field">
                <div class="fieldname">自动计算时长</div>
            </div>
            <div class="wf-setter-field wf-setting-duration">
                <label class="fieldblock">
                    <input type="checkbox" @change="changeComponent" value="1"
            ...
            <div class="wf-setting-duration-label" v-if="supportSetting.defaultAutorekonTime">
                <div class="wf-setter-field wf-setting-label">
                    <div class="fieldname">
                        <span>标题</span>
                        <span class="fieldinfo">最多10个字</span>
                    </div>
        ...
        <div v-if="supportSetting.sync" class="wf-setter-field wf-setting-required">
        ...
        <div v-if="supportSetting.print" class="wf-setter-field wf-setting-print">
