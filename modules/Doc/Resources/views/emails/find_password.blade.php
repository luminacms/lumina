...
<head>
    ...
    <title>找回密码 - {{wiki_config('SITE_NAME','XDoc')}}</title>
    <style type="text/css">
...
<div>
    <div class="wrapper" style="margin: 20px auto 0; width: 500px; padding-top:16px; padding-bottom:10px;">
        <div class="header clearfix">
            <a class="logo" href="http://www.xbhub.com/" ><b>{{wiki_config('SITE_NAME','XDoc')}}</b></a>
        </div>
        ...
        <div class="content" style="background: none repeat scroll 0 0 #FFFFFF; border: 1px solid #E9E9E9; margin: 2px 0 0; padding: 30px;">
            ...
            <p>您在 {{wiki_config('SITE_NAME','XDoc')}} 提交了找回密码申请。<br>如果您没有提交修改密码的申请, 请忽略本邮件</p>

            <p style="border-top: 1px solid #DDDDDD;margin: 15px 0 25px;padding: 15px;">
                请点击链接继续: <a href="{{$url}}" >{{$url}}</a>
            </p><p>

            </p><p class="footer" style="border-top: 1px solid #DDDDDD; padding-top:6px; margin-top:25px; color:#838383;">请勿回复本邮件, 此邮箱未受监控, 您不会得到任何回复. 要获得帮助, 请登录网站<br><br>
                <a href="http://www.xbhub.com/" >XDoc</a></p>
        </div>
    </div>
</div>
</body>
