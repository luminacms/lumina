...
<head>
    ...
    <title>接口测试工具 - {{wiki_config('SITE_NAME','XDoc')}}</title>
    ...
    <link href="{{asset('assets/doc/seltree/seltree.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/editormd/css/editormd.min.css')}}" rel="stylesheet">

    <link href="{{asset('assets/doc/styles/styles.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/bootstrap/icheck/skins/square/square.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/codemirror/lib/codemirror.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/styles/tool.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/styles/markdown.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/editormd/editormd.js')}}" rel="contents" id="editormdScript">
    <link href="{{asset('assets/doc/styles/runapi.css')}}" rel="stylesheet">
...
<script type="text/javascript" src="{{asset('assets/doc/bootstrap/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/bootstrap/icheck/icheck.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/layer/layer.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/seltree/seltree.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/scripts/jquery.form.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/codemirror/lib/codemirror.js')}}"></script>
<script src="{{asset('assets/doc/codemirror/mode/xml/xml.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/doc/codemirror/mode/javascript/javascript.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/doc/codemirror/mode/css/css.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/doc/codemirror/mode/htmlmixed/htmlmixed.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/doc/codemirror/addon/edit/matchbrackets.js')}}" type="text/javascript"></script>
<script src="{{asset('assets/doc/scripts/json2.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('assets/doc/scripts/runapi.js')}}"></script>
