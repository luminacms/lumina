...
<head>
    ...
    <title>用户注册 - {{wiki_config('SITE_NAME','XDoc')}}</title>
    ...
    <div class="row login">
        <div class="login-body">
            <form role="form" method="post" id="registerForm" action="{{route("account.register")}}" class="">
                ...
                <div class="checkbox">
                    已有账号？<a href="{{route('login')}}" style="display: inline-block;">立即登录</a>
                </div>
            </form>
        </div>
    </div>
...
<script src="{{asset('assets/doc/scripts/jquery.form.js')}}" type="text/javascript"></script>
