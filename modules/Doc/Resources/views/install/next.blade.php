...
<body>
<div class="container">
    <h3 style="margin-top: 0;text-align: center;margin-bottom: 20px;">XDoc安装</h3>
    ...
    <form method="post" action="{{route('install.index')}}" class="form-horizontal" role="form">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control" value="demo_xdoc" name="dataName" id="data-name" placeholder="数据库名称">
            </div>
        </div>
        <div class="form-group">
