...
<head>
    ...
    <title>{{$project_name}} -  {{wiki_config('SITE_NAME','XDoc')}}</title>
    <script src="{{asset('assets/doc/scripts/jquery.min.js')}}"></script>
    <script src="{{asset('assets/doc/scripts/jquery.form.js')}}"></script>
    <style type="text/css">
...
<div class="auth_form">
    <div class="shell">
        <form action="{{route('doc.check_document_auth')}}" method="post" id="auth_form">
