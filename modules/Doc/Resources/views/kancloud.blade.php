...
<head>
    ...
    <title>{{$title}} - {{wiki_config('SITE_NAME','XDoc')}}</title>
    <!-- Bootstrap -->
    ...
    <link href="{{asset('assets/doc/highlight/styles/default.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/highlight/styles/zenburn.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/jstree/themes/default/style.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/nprogress/nprogress.css')}}" rel="stylesheet">
    <link href="{{asset('assets/doc/styles/kancloud.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="{{ asset('js/zui.css') }}">
    ...
    <script src="{{asset('js/zui.min.js')}}" type="text/javascript"></script>
            ...
            <div class="navbar-header pull-right manual-menu">
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right" role="menu" aria-labelledby="dLabel">
                        ...
                        @endif
                        <li><a href="{{route('doc.document.export',['id' => $project->id])}}" >项目导出</a> </li>
                        <li><a href="{{route('doc.index')}}" title="返回首页">返回首页</a> </li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <article class="container-fluid manual-body">
        <div class="manual-left">
            ...
            <div class="m-copyright">
                <p>
                    本文档使用
                    <a href="http://www.xbhub.com" >XDoc</a> 发布
                </p>
            </div>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" value="{{route('doc.show',['id' => $project->id])}}" class="form-control" onmouseover="this.select()" id="projectUrl" title="项目地址">
                        </div>
...
<script type="text/javascript" src="{{asset('assets/doc/jstree/jstree.min.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/layer/layer.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/nprogress/nprogress.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/highlight/highlight.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/highlight/highlightjs-line-numbers.min.js')}}"></script>
