...
@section('styles')
<link href="{{asset('assets/doc/webuploader/webuploader.css')}}" rel="stylesheet">
<link href="{{asset('assets/doc/cropper/cropper.css')}}" rel="stylesheet">
    <style type="text/css">
...
@endsection
@section('scripts')
    <script type="text/javascript" src="{{asset('assets/doc/cropper/cropper.js')}}"></script>
    <script type="text/javascript" src="{{asset('assets/doc/webuploader/webuploader.js')}}"></script>
    ...
    try {
        var uploader = WebUploader.create({
            auto: false,
            swf: '{{asset('assets/doc/webuploader/Uploader.swf')}}',
            ...
            <div class="form-left">
                <form role="form" method="post" action="{{route('member.index')}}" id="basic-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="userNickname" id="user-nickname" max="20" placeholder="昵称" disabled value="{{$member->nickname or ''}}" autocomplete="off">
                    </div>
                    <div class="form-group">
            ...
            <div class="form-right">
                <label>
                    <a href="javascript:;" data-toggle="modal" data-target="#upload-logo-panel">
                        <img src="{{$member->headimgurl}}" onerror="this.src='{{asset('assets/doc/images/middle.gif')}}'" class="img-circle" alt="头像" style="max-width: 120px;max-height: 120px;" id="headimgurl">
                    </a>
                </label>
            </div>
        </div>
