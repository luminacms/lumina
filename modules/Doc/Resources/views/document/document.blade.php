...
<head>
    ...
    <title>编辑文档 - {{wiki_config('SITE_NAME','XDoc')}}</title>
    ...
    <link href="{{asset('assets/doc/styles/wikiedit.css')}}" rel="stylesheet">
...
<script type="text/javascript" src="{{asset('assets/doc/scripts/json2.js')}}"></script>
<script type="text/javascript" src="{{asset('assets/doc/editormd/editormd.js')}}"></script>
...
<script type="text/javascript" src="{{asset('assets/doc/scripts/wiki.js')}}"></script>
</body>
</html>