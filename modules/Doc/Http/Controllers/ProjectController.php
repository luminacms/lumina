...
use Modules\Doc\Models\Relationship;
...
//        }
    ...
    public function delete($id)
    {
        ...
        return view('doc::project.delete',$this->data);
    }
    /**
     * 编辑项目或创建
     * @param int $id
...
//        }
        ...
        if($this->isPost()){
            ...
            $project->create_by = $this->member_id;

            $project->save();

            return $this->jsonResult(0,$project);
...
//            }
        ...
        return view('doc::project.edit',$this->data);
    }
    ...
    public function members($id)
    {
        ...
        return view('doc::project.members',$this->data);
    }
