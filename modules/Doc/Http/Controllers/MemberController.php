...
//        }
        ...
        return view('doc::member.index', $this->data);
    }
    ...
    public function account()
    {
        ...
        return view('doc::member.account',$this->data);
    }
    ...
    public function projects()
    {
        ...
        return view('doc::member.projects',$this->data);
    }
    ...
    public function setting()
    {
        ...
        return view('doc::member.setting',$this->data);
    }
    ...
    public function editSetting($id = null)
    {
        ...
        return view('doc::member.setting_edit',$this->data);
    }
    ...
    public function users()
    {
        ...
        return view('doc::member.users',$this->data);
    }
    ...
    public function editUser($id = null)
    {
        if($this->isPost()){
            ...
            if($member_id > 0) {
                ...
                $member->create_by = $this->member_id;
            }
        ...
        return view('doc::member.users_edit',$this->data);
    }
    ...
    public function register(Request $request)
    {
        ...
        return view('doc::member.register');
    }
