...
{{--                        @foreach(\App\Models\Account::where('platform', 'WECHAT')->get() as $_account)--}}
{{--                            <option value="/wechat/callback?aid={{ $_account['aid'] }}">{{ $_account['name'] }}</option>--}}
{{--                        @endforeach--}}
                    </select>
                </div>
            </div>
            ...
            <div class="form-group content_type" id="image">
                ...
                <div class="col-sm-10 col-xs-12">
                    <input type="text" id="picurl" value="http://mat1.gtimg.com/www/images/qq2012/qqlogo_1x.png" class="form-control" />
                </div>
            </div>
    ...
    <div class="float-right w-1/3" id="demoSendBox">
        <div class="chatPanel form" style="width:300px;">
            <div class="page-header">
                <h4>预览效果</h4>
            </div>
            <div id="svposttext" style="text-align:left; padding-bottom:10px;display:none;">
                <img src='assets/imgs/avatar/default.gif" style="width:34px;height:34px;margin-right:6px;float:right;" class="img-rounded">
            ...
            <div class="chatItem you">
                <div id="svtext" style="text-align:left; padding-bottom:10px;display:none;">
                    <img src='assets/imgs/avatar/default.gif" style="width:34px;height:34px;margin-left:6px; float:left;" class="img-rounded">
