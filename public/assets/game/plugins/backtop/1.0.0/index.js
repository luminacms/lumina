! function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t(require("$GP")) : "function" == typeof define && define.amd ? define(["$GP"], t) : "object" == typeof exports ? exports["backtop@1.0.0index"] = t(require("$GP")) : e["backtop@1.0.0index"] = t(e.$GP)
    ...
    return function (e) {
        ...
        }, t.p = "https://ymm-maliang.oss-cn-hangzhou.aliyuncs.com/ymm-maliang/122410000/backtop/1.0.0/", t(t.s = 6)
    }([function (e, t) {
        function n(e, t) {
            var n = e[1] || "",
                o = e[3];
        ...
        function a(e) {
            ...
            if (g) {
                var o = v++;
                r = l || (l = i()), t = s.bind(null, r, o, !1), n = s.bind(null, r, o, !0)
        ...
        var s = n(10),
            u = n(3),
            c = r,
            f = Object(u.a)(i.a, s.a, s.b, !1, c, "data-v-1a81bada", null);
        t.default = f.exports
    }, function (e, t, n) {
        var r = n(8);
        "string" == typeof r && (r = [
        ...
        t = e.exports = n(0)(!1), t.push([e.i, ".w_backtop[data-v-1a81bada]{position:fixed;right:50px;bottom:50px;width:50px;height:50px;background:#fff;border-radius:50%;box-shadow:2px 2px 10px rgba(0,0,0,.175);display:-webkit-flex;display:flex;-webkit-justify-content:center;justify-content:center;-webkit-align-items:center;align-items:center;padding-bottom:12px;cursor:pointer}.w_backtop>span[data-v-1a81bada]{display:inline-block;border:12px solid transparent;border-bottom-color:#ccc}", ""])
    }, function (t, n) {
        t.exports = e
    }, function (e, t, n) {
        "use strict";
