...
@section('content')
    <x-submenu :items="
        [
            ...
            ['name' => '新增', 'uri' => route('mall.product-spus.create'), 'right'=>true],
       ]" />
    ...
    <div class="layui-form-item layui-layout-admin">
        <div class="layui-input-block">
            <div class="layui-footer" style="left:0;">
                <button class="layui-btn" lay-submit lay-filter="webide-form">提交</button>
            </div>
        </div>
    </div>
...
@push('script')
    ...
    <script>
        layui.use(['index', 'form', 'jstree'], function(){
            var $ = layui.jquery,
                layer = layui.layer,
                form = layui.form,
                jstree = layui.jstree,
