...
layui.define('jquery', function (exports) {
    ...
    Class.prototype.render = function () {
        ...
        if (options.input && !options.range) {
            var elemInput = $('<div class="layui-slider-input layui-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="fa fa-up"></i><i class="fa fa-down"></i></div></div>');
    ...
    Class.prototype.slide = function (setValue, value, i) {
        var that = this,
            ...
            change = function (offsetValue, index) {
                ...
                if (options.range) {
                    var arrValue = [
                        sliderWrap.eq(0).data('value'), sliderWrap.eq(1).data('value')
                    ];
